...
HD_PWD='C:/Users/ivanv/Downloads/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_cmd_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_cmd_uart.tcl
