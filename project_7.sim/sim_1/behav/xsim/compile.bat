...
REM
REM Generated by Vivado on Mon Nov 10 07:08:48 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_top_cmd_uart_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_top_cmd_uart_vlog.prj -log xvlog.log
